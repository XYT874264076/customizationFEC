...
#ifndef EXAMPLES_CUSTOMIZATION_RTCP_FEC_RECEIVER_REPORT_H_
#define EXAMPLES_CUSTOMIZATION_RTCP_FEC_RECEIVER_REPORT_H_
...
#endif  //  EXAMPLES_CUSTOMIZATION_RTCP_FEC_RECEIVER_REPORT_H_