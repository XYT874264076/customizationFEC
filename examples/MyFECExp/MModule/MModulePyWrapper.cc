...
#include "examples/MyFECExp/MModule/MModulePyWrapper.h"
...
MModuleRLWrapper::MModuleRLWrapper() {
    ...
    if (inputV::Params::ifSaveM) {
        // rl_module = rl_model.attr("RLModule")("examples/MyFECExp/MModule/checkpoints/model_weightsV15.pth",true); // Initialize the Python class
        rl_module = rl_model.attr("RLModule")("../examples/MyFECExp/MModule/checkpoints/model_weights_NRV2.pth",true);
    }
    else {
        // rl_module = rl_model.attr("RLModule")("examples/MyFECExp/MModule/checkpoints/model_weightsV15.pth",false); // Initialize the Python class
        rl_module = rl_model.attr("RLModule")("../examples/MyFECExp/MModule/checkpoints/model_weights_NRV2.pth",false);
    }
}
