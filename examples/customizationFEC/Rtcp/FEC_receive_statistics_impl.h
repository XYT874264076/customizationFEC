...
#ifndef EXAMPLES_CUSTOMIZATION_RTCP_FEC_RECEIVE_STATISTICS_IMPL_H_
#define EXAMPLES_CUSTOMIZATION_RTCP_FEC_RECEIVE_STATISTICS_IMPL_H_
...
#endif  // EXAMPLES_CUSTOMIZATION_RTCP_FEC_RECEIVE_STATISTICS_IMPL_H_