...
struct FrameLog
{
  ...
  static const char* header() {
    return "frame_num_,not_decoded_,decoded_after_frames_,time_spent_decode_,first_ts_,first_data_ts_,first_par_ts_,last_data_ts_,last_par_ts_,decode_ts_,all_data_received\n";
  }
