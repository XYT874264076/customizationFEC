...
#ifndef TEST_MP4_VIDEO_PLAYER_H_
#define TEST_MP4_VIDEO_PLAYER_H_
...
class MP4VideoPlayer : public rtc::VideoSourceInterface<VideoFrame> {
 public:
  ...
  void OnOutputFormatRequest(int width, int height, const std::optional<int>& max_fps);
...
#endif  //TEST_MP4_VIDEO_PLAYER_H_